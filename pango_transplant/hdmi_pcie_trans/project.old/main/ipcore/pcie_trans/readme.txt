...
--/rtl                                  //PCIe IP包含的设计代码
  ...
  -- /ipsl_apb_cross_v1_0.vp            //APB接口跨时钟域模块
  -- /ipsl_pcie_apb_mux_v1_1.vp         //APB接口片选模块
  -- /ipsl_apb2dbi_v1_0.vp              //APB接口转DBI接口模块
  -- /ipsl_pcie_cfg_init_v1_3.vp        //PCIe配置空间寄存器初始化模块
  -- /ipsl_pcie_hard_ctrl_v1_3.vp       //Pango PCIe模块
  -- /ipsl_pcie_soft_phy_v1_2a.v        //Pango Soft Phy模块
  -- /ipsl_pcie_top_v1_3.vp             //Pango PCIe IP顶层文件
  -- /ipsl_seio_intf_v1_0.vp            //SEIO接口处理模块
  --/ipsl_pcie_sync_v1_0.vp             //Pcie同步模块
